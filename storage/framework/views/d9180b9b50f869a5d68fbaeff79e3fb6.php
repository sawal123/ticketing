        ...
        <div class="flex items-center gap-2 flex-shrink-0">
            ...
            <div class="relative ml-1">
                <button id="profileBtn" onclick="toggleProfileDropdown()" class="flex items-center gap-2 p-1.5 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-700 transition-all duration-200" aria-label="Profil pengguna">
                    ...
                    <span class="text-sm font-medium text-slate-700 dark:text-slate-200 hidden md:inline"><?php echo e(auth()->user()->name ?? 'Admin'); ?></span>
                ...
                <div id="profileDropdown" class="dropdown-profile absolute right-0 mt-2 w-48 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-lg py-1 z-50">
                    ...
                    <a href="<?php echo e(url('/logout')); ?>" class="flex items-center gap-2 px-4 py-2 text-sm text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-900/30 transition-colors">
...
<?php /**PATH J:\PROJECT\GOTIK\TiketKonser\resources\views/layouts/partials/header.blade.php ENDPATH**/ ?>