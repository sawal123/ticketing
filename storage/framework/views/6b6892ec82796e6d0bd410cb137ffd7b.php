<div class="modal fade" id="modalTerm">
    <div class="modal-dialog modal-dialog-centered text-center" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <form action="<?php echo e(url('admin/addTerm')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="updateTerm">
    <div class="modal-dialog modal-dialog-centered text-center" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <form action="<?php echo e(url('admin/editTerm')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
...
</div><?php /**PATH F:\PROJECT\GOTIK\TiketKonser\resources\views/backend/molecul/landing/modalTerm.blade.php ENDPATH**/ ?>