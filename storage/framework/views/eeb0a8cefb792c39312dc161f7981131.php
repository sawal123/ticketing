...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginal187e7f8ae725d0d7c586a97e85953c03 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal187e7f8ae725d0d7c586a97e85953c03 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.input','data' => ['label' => 'Maks. Diskon (Rp)','type' => 'number','wire:model.live' => 'max_disc','min' => '0','placeholder' => '0','readonly' => ''.e($unit == 'rupiah').'','class' => ''.e($unit == 'rupiah' ? 'bg-slate-100 opacity-70 cursor-not-allowed' : '').'','error' => ''.e($errors->first('max_disc')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('admin.input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Maks. Diskon (Rp)','type' => 'number','wire:model.live' => 'max_disc','min' => '0','placeholder' => '0','readonly' => ''.e($unit == 'rupiah').'','class' => ''.e($unit == 'rupiah' ? 'bg-slate-100 opacity-70 cursor-not-allowed' : '').'','error' => ''.e($errors->first('max_disc')).'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php unset($__componentOriginal883972b03e56cea0994a1aaccc5761f0); ?>
<?php endif; ?>
</div><?php /**PATH J:\PROJECT\GOTIK\TiketKonser\resources\views/livewire/dashboard/voucher-index.blade.php ENDPATH**/ ?>