<?php $__env->startSection('content'); ?>
    ...
    <div class="main-container container-fluid dashboard-bg pt-4 pb-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <?php echo $__env->make('penyewa.molecul.modalCash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-xl-7">
                ...
                <div class="card-ui p-4">
                    ...
                    <div class="text-huge">Rp <?php echo e(number_format($totalAmount, 0, ',', '.')); ?></div>
                </div>
                ...
                <div class="stat-grid mb-4">
                    <div class="box-stat">
                        ...
                        <div class="text-large"><?php echo e(number_format($totalTransaksi, 0, ',', '.')); ?></div>
                    </div>
                    <div class="box-stat">
                        <div class="stat-label">Total Tiket (Sell)</div>
                        <div class="text-large"><?php echo e(number_format($totalTiket, 0, ',', '.')); ?></div>
                    </div>
                    <div class="box-stat">
                        <div class="stat-label">Total Event</div>
                        <div class="text-large"><?php echo e($eventCount); ?></div>
                    </div>
                </div>
                    ...
                    <div class="row gx-3">
                        <div class="col-6">
                            <div class="gender-badge">
                                ...
                                <div class="gender-val"><?php echo e(number_format($dataUser[2], 0)); ?>%</div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="gender-badge">
                                <div class="gender-label">Presentase Wanita</div>
                                <div class="gender-val"><?php echo e(number_format($dataUser[3], 0)); ?>%</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-ui p-3 flex-grow-1 d-flex flex-column">
                        ...
                        <?php else: ?>
                            <div class="text-center text-muted flex-grow-1 d-flex align-items-center justify-content-center flex-column"
                                ...
                                <a href="<?php echo e(url('/dashboard/event/addEvent')); ?>" class="btn btn-primary btn-sm mt-3 px-4"
                ...
                <div class="modal-body pt-2">
                    ...
                    <div class="d-flex gap-2 mb-3">
                        <div class="gender-row mb-0 flex-grow-1 px-3">
                            ...
                            <span class="value"><?php echo e($dataUser[0]); ?></span>
                        </div>
                        <div class="gender-row mb-0 flex-grow-1 px-3">
                            <span class="title">Wanita</span>
                            <span class="value"><?php echo e($dataUser[1]); ?></span>
                        </div>
                    </div>

                    <!-- Range Umur -->
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $birtday; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $genders): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="gender-row">
                            <span class="title"><?php echo e($index); ?></span>
                            <!-- Jumlah total Pria + Wanita di range ini -->
                            <span class="value"><?php echo e(($genders['pria'] ?? 0) + ($genders['wanita'] ?? 0)); ?></span>
                        </div>
...
<?php echo $__env->make('penyewa.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH J:\PROJECT\GOTIK\TiketKonser\resources\views/penyewa/page/dashboard.blade.php ENDPATH**/ ?>