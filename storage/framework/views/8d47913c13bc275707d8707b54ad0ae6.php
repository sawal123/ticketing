...
<body
    ...
    <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; border: 1px solid #ddd;">
        <h2 style="color: #0d6efd; margin-top: 0;">Halo, <?php echo e($name); ?>!</h2>
        ...
        <p style="font-size: 12px; color: #6c757d;">
            ...
            <a href="<?php echo e($url); ?>" style="color: #0d6efd;"><?php echo e($url); ?></a>
        </p>
    </div>
...
<?php /**PATH F:\PROJECT\GOTIK\TiketKonser\resources\views/email/staff_invitation.blade.php ENDPATH**/ ?>