<div class="sm:mx-auto sm:w-full sm:max-w-md p-2">
    ...
    <div class="bg-[#16152a] border border-white/5 py-10 px-6 shadow-2xl rounded-[2.5rem] sm:px-10 relative overflow-hidden">
        ...
        <div class="relative">
            <h2 class="text-3xl font-extrabold text-white text-center mb-2 tracking-tight">Selamat Datang!</h2>
            <p class="text-slate-400 text-center text-sm mb-10">Silakan masuk ke akun Anda untuk melanjutkan.</p>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    <div class="flex items-center justify-between mb-2 ml-1">
                        ...
                        <a href="<?php echo e(route('forgot')); ?>" class="text-xs font-bold text-indigo-400 hover:text-indigo-300 transition-colors">Lupa Password?</a>
                    </div>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <i data-lucide="lock" class="h-4 w-4 text-slate-500"></i>
                        </div>
                        <input wire:model="password" id="password" type="password" required class="block w-full pl-11 pr-4 py-4 bg-[#1e1d35] border-0 ring-1 ring-white/5 focus:ring-2 focus:ring-indigo-500 rounded-2xl text-white text-sm placeholder-slate-500 transition-all duration-200" placeholder="••••••••">
                    </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="flex items-center ml-1">
                    <input wire:model="remember" id="remember" type="checkbox" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-white/10 rounded bg-[#1e1d35]">
            ...
            <div class="mt-8">
                ...
                <div class="mt-6">
                    <a href="#" class="w-full inline-flex justify-center py-4 px-4 rounded-2xl bg-white/5 border border-white/5 text-white text-sm font-bold hover:bg-white/10 transition-all duration-200 gap-3 items-center">
    ...
    <p class="mt-10 text-center text-sm text-slate-400">
        Belum punya akun?
        <a href="/register" wire:navigate class="font-bold text-indigo-400 hover:text-indigo-300 transition-colors ml-1">Daftar sekarang</a>
    </p>
</div>
<?php /**PATH F:\PROJECT\GOTIK\TiketKonser\resources\views/livewire/auth/login.blade.php ENDPATH**/ ?>