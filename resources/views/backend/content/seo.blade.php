                    ...
                    <div class="card p-0">
                        <div class="card-body p-4">
                            ...
                            <div class="text-center">
                                <img src="{{ url('storage/logo/' . $logo[0]->logo) }}" alt="" srcset="" width="100">
                            </div>
                            <form class="mt-3" action="{{ url('admin/editLogo') }}" method="post" enctype="multipart/form-data">
                                @csrf
                ...
                <div class="col">
                    <div class="card p-0">
                        <div class="card-body p-4">
                            ...
                            <hr>
                            <div class="text-center">
                                <img src="{{ url('storage/logo/' . $logo[0]->icon) }}" alt="" srcset="" width="100">
                            </div>
                            <form class="mt-3" action="{{ url('admin/editIcon') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" value="{{ $logo[0]->id }}" name="id">
