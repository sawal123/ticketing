...
@section('content')
    <div class="page-header">
        <h1 class="page-title">Penyewa</h1>
        <div>
            <ol class="breadcrumb">
                ...
                <div class="card-header d-flex justify-content-between">
                    ...
                    <button type="submit" class="modal-effect btn btn-primary " data-bs-target="#modalAdmin"
                        data-bs-effect="effect-sign" data-bs-toggle="modal"><i
                            class="fa fa-plus-square me-2"></i>New Penyewa</button>
                                    ...
                                    <tr class="border-bottom">
                                        ...
                                        <td>
                                            <div class="g-2">
                                                ...
                                                data-kota="{{ $users->kota }}" data-alamat="{{ $users->alamat }}" data-role="{{ $users->role }}"
                                                data-nomor="{{ $users->nomor }}" data-gender="{{ $users->gender }}"
                                                data-bs-target="#upUser" data-bs-effect="effect-sign"
                                                data-bs-toggle="modal"><span class="fe fe-edit fs-14"></span></button>
