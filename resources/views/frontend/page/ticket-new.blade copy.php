                        ...
                        @foreach ($list as $key => $hargaItem)
                            ...
                            <div class="ticket-tier">
                                ...
                                @if ($sold < $qty && $hargaItem->status === 'active')
                                    <div class="qty-control ticket-quantity-control"
                                        data-target="quantity{{ $loop->index }}" data-price="{{ $hargaItem->harga }}"
                                        data-max="5">
                                        <input type="hidden" class="ticket-price-input" name="harga{{ $loop->index }}"
                                        ...
                                        <input type="text"
                                            class="form-control qty-num p-0 qty-input text-center border-0 bg-transparent"
                                            value="0" max="5" step="1" name="ticket{{ $loop->index }}"
                                            data-quantity-input="quantity{{ $loop->index }}" readonly>
                            ...
                            <div class="sheet-tier">
                                ...
                                @if ($soldMob < $qtyMob && $hargaItemMobile->status === 'active')
                                    <div class="qty-control ticket-quantity-control"
                                        ...
                                        <input type="text"
                                            class="qty-num qty-input text-center border-0 bg-transparent" min="0"
