...
<div class="slider-section" id="homepage-slider" data-slide-count="{{ count($slide) }}">
    <div class="slider-viewport">
        <div class="slider-track" id="track">
            @foreach ($slide as $slider)
                <div class="slide">
                    <div class="slide-media sp-1">
                        <img class="slide-img" src="{{ asset('storage/slide/' . $slider->gambar) }}" alt="Slide">
                    </div>
