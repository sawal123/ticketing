<div class="sm:mx-auto sm:w-full sm:max-w-md">
    ...
    <p class="mt-2 text-center text-sm text-slate-500">
        Selamat datang, <span class="font-bold text-indigo-600">{{ $staff->name }}</span>. Lengkapi profil Anda untuk mulai menggunakan dashboard.
    </p>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                ...
                                @error('password') <p class="mt-1 text-xs text-rose-500 ml-1">{{ $message }}</p> @enderror
                            </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                @error('nomor') <p class="mt-1 text-xs text-rose-500 ml-1">{{ $message }}</p> @enderror
                            </div>
                            ...
                            <div>
                                ...
                                @error('birthday') <p class="mt-1 text-xs text-rose-500 ml-1">{{ $message }}</p> @enderror
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            @error('alamat') <p class="mt-1 text-xs text-rose-500 ml-1">{{ $message }}</p> @enderror
                        </div>
                    </div>
