...
<div class="rounded-[2rem] border border-slate-200 bg-white shadow-sm overflow-hidden mb-6">
    ...
    <div class="p-6">
        <h4 class="text-sm font-black uppercase tracking-[0.25em] text-slate-700 mb-4">
                        ...
                        @foreach ($preview['diffs'] as $diff)
                            <tr class="hover:bg-slate-50/50 transition">
                                <td class="px-5 py-3.5 font-bold text-slate-700">
                                    <span class="inline-flex items-center rounded-lg bg-slate-100 px-2 py-0.5 text-xs font-medium text-slate-600">
                                        {{ $diff['section'] }}
                                    </span>
                                </td>
                                <td class="px-5 py-3.5 font-semibold text-slate-900">{{ $diff['label'] }}</td>
