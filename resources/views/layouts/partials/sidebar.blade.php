<aside id="sidebar" class="fixed lg:sticky top-0 left-0 z-50 w-64 h-full flex flex-col shadow-lg lg:shadow-none sidebar-transition -translate-x-full lg:translate-x-0 transition-colors duration-300 border-r border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-300" aria-label="Sidebar navigasi">
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1" aria-label="Menu utama">
        ...
        <!-- a. Dashboard -->
        <a href="{{ route('dashboard.demo') }}" wire:navigate class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-all duration-200 {{ request()->routeIs('dashboard.demo') ? 'active' : '' }}">
            <i data-lucide="layout-dashboard" class="w-5 h-5 flex-shrink-0"></i>
            <span class="text-sm font-medium">Dashboard</span>
        </a>

        <!-- b. Event -->
        <a href="{{ auth()->user()->role === 'admin' ? route('admin.event') : route('dashboard.demo.event') }}" wire:navigate class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-all duration-200 {{ request()->routeIs('admin.event') || request()->routeIs('dashboard.demo.event') ? 'active' : '' }}">
            <i data-lucide="calendar" class="w-5 h-5 flex-shrink-0"></i>
            <span class="text-sm font-medium">Event</span>
        </a>

        <!-- c. Voucher -->
        <a href="{{ url('/dashboard/voucher') }}" wire:navigate class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-all duration-200 {{ request()->is('*voucher*') ? 'active' : '' }}">
            <i data-lucide="ticket" class="w-5 h-5 flex-shrink-0"></i>
            <span class="text-sm font-medium">Voucher</span>
        </a>

        <!-- d. Partner -->
        <a href="{{ url('/dashboard/partner') }}" wire:navigate class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-all duration-200 {{ request()->is('*partner*') ? 'active' : '' }}">
        ...
        <!-- e. Money -->
        <a href="{{ url('/dashboard/money') }}" wire:navigate class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-all duration-200 {{ request()->is('*money*') ? 'active' : '' }}">
            <i data-lucide="banknote" class="w-5 h-5 flex-shrink-0"></i>
            <span class="text-sm font-medium">Money</span>
        </a>

        <!-- f. Penarikan Saldo -->
        <a href="{{ auth()->user()->role === 'admin' ? route('admin.penarikan') : url('/dashboard/money') }}" wire:navigate class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-all duration-200 {{ request()->is('*penarikan*') ? 'active' : '' }}">
            <i data-lucide="wallet" class="w-5 h-5 flex-shrink-0"></i>
            <span class="text-sm font-medium">Penarikan Saldo</span>
        </a>

        <!-- g. Staff -->
        <a href="{{ url('/dashboard/staff') }}" wire:navigate class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-all duration-200 {{ request()->is('*staff*') ? 'active' : '' }}">
        ...
        <!-- h. Pengaturan Akun -->
        <a href="{{ auth()->user()->role === 'admin' ? route('admin.setting') : url('/dashboard/profile') }}" wire:navigate class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-all duration-200 {{ request()->is('*setting*') || request()->is('*profile*') ? 'active' : '' }}">
            <i data-lucide="settings" class="w-5 h-5 flex-shrink-0"></i>
            <span class="text-sm font-medium">Pengaturan Akun</span>
        </a>

        <!-- i. Landing Page -->
        <a href="{{ route('admin.setting') }}" wire:navigate class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-all duration-200">
