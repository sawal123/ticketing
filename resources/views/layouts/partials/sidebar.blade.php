<aside id="sidebar"
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1" aria-label="Menu utama">
        ...
        <!-- a. Dashboard -->
        <a href="{{ route('dashboard.demo') }}" wire:navigate
            class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-all duration-200 {{ request()->routeIs('dashboard.demo') ? 'active' : '' }}">
            <i data-lucide="layout-dashboard" class="w-5 h-5 flex-shrink-0"></i>
            <span class="text-sm font-medium">Dashboard</span>
        </a>

        <!-- b. Event -->
        <a href="{{ auth()->user()->role === 'admin' ? route('admin.event') : route('dashboard.demo.event') }}"
            wire:navigate
            class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-all duration-200 {{ request()->routeIs('admin.event') || request()->routeIs('dashboard.demo.event') ? 'active' : '' }}">
            <i data-lucide="calendar" class="w-5 h-5 flex-shrink-0"></i>
            <span class="text-sm font-medium">Event</span>
        </a>

        <!-- c. Voucher -->
        <a href="{{ route('dashboard.demo.voucher') }}" wire:navigate
            class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-all duration-200 {{ request()->routeIs('dashboard.demo.voucher') ? 'active' : '' }}">
            <i data-lucide="ticket" class="w-5 h-5 flex-shrink-0"></i>
            <span class="text-sm font-medium">Voucher</span>
        </a>

        <!-- d. Partner -->
        <a href="{{ route('dashboard.demo.partner') }}" wire:navigate
            class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-all duration-200 {{ request()->routeIs('dashboard.demo.partner') ? 'active' : '' }}">
        ...
        <!-- f. Penarikan Saldo -->
        <a href="{{ auth()->user()->role === 'admin' ? route('admin.penarikan') : route('dashboard.demo.penarikan') }}"
            wire:navigate
            class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-all duration-200 {{ request()->routeIs('admin.penarikan') || request()->routeIs('dashboard.demo.penarikan') ? 'active' : '' }}">
            <i data-lucide="wallet" class="w-5 h-5 flex-shrink-0"></i>
            <span class="text-sm font-medium">Penarikan Saldo</span>
        </a>

        <!-- g. Staff -->
        <a href="{{ route('dashboard.demo.staff') }}" wire:navigate
            class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-all duration-200 {{ request()->routeIs('dashboard.demo.staff') ? 'active' : '' }}">
        ...
        <!-- h. Pengaturan Akun -->
        <a href="{{ auth()->user()->role === 'admin' ? route('admin.setting') : url('/dashboard/profile') }}"
            wire:navigate
            class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-all duration-200 {{ request()->is('*setting*') || request()->is('*profile*') ? 'active' : '' }}">
