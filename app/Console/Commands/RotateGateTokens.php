...
class RotateGateTokens extends Command
{
    ...
    protected $description = 'Rotate gate tokens for unscanned SUCCESS tickets in one explicitly named event.';
    ...
    public function handle(GateTokenService $tokens): int
    {
        ...
        $this->line("Akan rotasi: {$counts['eligible']}");
        ...
        $this->info("Rotasi selesai: {$rotated} token diterbitkan ulang.");
