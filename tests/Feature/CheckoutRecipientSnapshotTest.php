...
class CheckoutRecipientSnapshotTest extends TestCase
{
    ...
    public function test_ticket_holder_name_is_required_and_not_defaulted_from_user_name(): void
    {
    ...
    public function test_account_email_option_stores_logged_in_user_email_snapshot_without_changing_user_identity(): void
    {
    ...
    public function test_other_email_option_stores_alternative_snapshot_without_changing_midtrans_customer_identity(): void
    {
        ...
        $this->actingAs($user)->post('/paynow', [
            'cart_uid' => $cart->uid,
            'payment_gateway_id' => $gateway->id,
            'ticket_holder_name' => 'Nama Legal Satu',
    ...
    public function test_invalid_alternative_email_is_rejected(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->post('/paynow', [
                ...
                'ticket_holder_name' => 'Nama Tiket',
                'ticket_recipient_email_option' => 'other_email',
                'ticket_recipient_other_email' => 'bukan-email-valid',
            ])
            ->assertRedirect('/detail-ticket/'.$cart->uid.'/'.$user->uid)
            ->assertSessionHasErrors(['msg']);
    ...
    public function test_other_email_option_requires_email_value(): void
    {
        $user = $this->user();
        $event = $this->event();
        $cart = $this->cart($user, $event);
    ...
    public function test_snapshot_cannot_be_overwritten_after_active_payment_link_exists(): void
    {
        ...
        $cart = $this->cart($user, $event, [
            ...
            'ticket_holder_name' => 'Snapshot Awal',
        ...
        $this->actingAs($user)->post('/paynow', [
            ...
            'ticket_recipient_email_option' => 'other_email',
            'ticket_recipient_other_email' => 'baru@example.test',
        ])->assertRedirect('https://pay.example.test/existing');
    ...
    public function test_verified_checkout_payment_otp_flow_still_works_with_recipient_snapshot(): void
    {
        ...
        $this->assertSame('otp-recipient@example.test', $cart->ticket_recipient_email);
